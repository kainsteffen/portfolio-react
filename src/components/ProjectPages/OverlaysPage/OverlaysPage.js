...
class OverlaysPage extends Component {
            ...
            <React.Fragment>
                <main>
                    ...
                    <article className='project-page'>
                        <img src={require('./images/overlays-thumbnail.png')} className='project-page-header-image' alt='Overlays thumbnail' />
                        <div>
                            ...
                            />
                            <p>
                                Overlays is an educational mobile game that was made as part of the IMI Showtime 2018 project
                                convention from the HTW University. The game won both the jury's and community's choice
                                awards for best Bachelor project of the show.
                                    <br /><br />
                                The game aims to introduce the player to image processing concepts (i.e. various algorithms that Adobe Photoshop uses)
                                 in a laser puzzle format. Players move, rotate and reflect lasers to create new and exciting images.
                                    </p>
                            <BulletList
                                title='Features:'
                                items={[
    ...
    handlePlayStoreButtonPress() {
        window.open('https://play.google.com/store/apps/details?id=com.overlaysteam.overlays')
    }
}
